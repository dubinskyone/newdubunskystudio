...
function HeroLite({ copy, titleWordsArray }: { copy: HeroCopy; titleWordsArray: string[] }) {
  ...
  return (
    <section
      id="top"
      className="relative flex min-h-[76svh] scroll-mt-28 flex-col items-center justify-center overflow-hidden px-4 pb-10 pt-24 text-center sm:min-h-[82svh] sm:pb-14 sm:pt-30 md:scroll-mt-32"
    >
      ...
      <div className="relative z-10 mx-auto mt-2 flex max-w-[1120px] flex-col items-center sm:mt-8">
        <div
        ...
        <h1 className="mb-6 flex max-w-[980px] flex-col items-center gap-y-1 text-center text-[13.5vw] font-sans font-bold leading-[1.02] tracking-tight text-text-main sm:mb-7 sm:text-[14vw] sm:font-display sm:text-7xl lg:text-[5rem]">
        ...
        <p
          className="mobile-hero-reveal mb-8 max-w-[700px] text-[15px] leading-7 text-white/72 sm:mb-10 sm:text-lg sm:text-text-muted md:text-xl"
        ...
        <div
          className="mobile-hero-reveal mb-8 flex w-full flex-col items-center justify-center gap-4 sm:mb-12 sm:w-auto sm:flex-row"
        ...
        <div
          className="mobile-hero-reveal mb-10 flex max-w-[760px] flex-wrap items-center justify-center gap-2.5 sm:mb-16"
          style={heroDelayStyle(580)}
        >
        ...
        <div className="mobile-hero-reveal" style={heroDelayStyle(640)}>
...
export function Hero() {
  ...
  const copy: HeroCopy = {
    ...
    focusItems: [
      ...
      t('hero', 'focus3'),
      t('hero', 'focus4'),
    ].filter((item) => item && !item.startsWith('focus')),
  };
