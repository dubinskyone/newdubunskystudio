...
export const translations = {
  RU: {
    ...
    hero: {
      ...
      title1: 'Создаем',
      title2: 'цифровые',
      titleWords: 'цифровые|финтех|B2B|web3',
      title3: 'продукты',
      desc: 'Помогаем запускать ',
      descHighlight: 'MVP, B2B-платформы и fintech/web3 продукты',
      descEnding: '. Берём на себя продуктовую структуру, UI/UX и разработку, чтобы вы быстрее дошли до рабочего релиза.',
      contact: 'Связаться',
      cases: 'Смотреть кейсы',
      trusted: 'Проекты в портфолио',
      focus1: 'MVP под ключ',
      focus2: 'B2B платформы',
      focus3: 'Fintech & Web3',
      focus4: 'Design + code',
    },
    cta: {
  ...
  EN: {
    ...
    hero: {
      ...
      title1: 'We build',
      title2: 'digital',
      titleWords: 'digital|fintech|B2B|web3',
      title3: 'products',
      desc: 'We help teams launch ',
      descHighlight: 'MVPs, B2B platforms, and fintech/web3 products',
      descEnding: '. We own product structure, UI/UX, and development so you reach a working release faster.',
      contact: 'Contact Us',
      cases: 'View Cases',
      trusted: 'Selected product work',
      focus1: 'Turnkey MVPs',
      focus2: 'B2B platforms',
      focus3: 'Fintech & Web3',
      focus4: 'Design + code',
    },
    cta: {
  ...
  UA: {
    ...
    hero: {
      ...
      title1: 'Створюємо',
      title2: 'цифрові',
      titleWords: 'цифрові|фінтех|B2B|web3',
      title3: 'продукти',
      desc: 'Допомагаємо запускати ',
      descHighlight: 'MVP, B2B-платформи та fintech/web3 продукти',
      descEnding: '. Беремо на себе продуктову структуру, UI/UX і розробку, щоб ви швидше дійшли до робочого релізу.',
      contact: 'Зв\'язатися',
      cases: 'Дивитися кейси',
      trusted: 'Проєкти в портфоліо',
      focus1: 'MVP під ключ',
      focus2: 'B2B платформи',
      focus3: 'Fintech & Web3',
      focus4: 'Design + code',
    },
    cta: {
